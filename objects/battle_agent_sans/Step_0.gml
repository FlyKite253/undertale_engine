...
if (action == 0)
{
    if (_action_step != 1)
    {
        _body_sprite = _body_sprite_original
        _body_x = 0
        _body_y = 0
        _body_image = 0
        _body_speed = 0.065
    ...
    if (_action_step <= 4)
    {
        switch _action_step
        {
            ...
            case 1:
                {
                    _body_x = 5
					 _body_sprite = _body_sprite_left
                    _body_speed = 0.5
                }
                break
...
else if (action == 2)
{
    if (_action_step <= 5)
    {
        switch _action_step
        {
            case 0:
                {
                    _body_sprite = _body_sprite_right
                    _body_x = 0
                    _body_y = 0
                    _body_image = 0
                    _body_speed = 0.2
...
else if (action == 4)
{
    if (_action_step <= 4)
    {
        switch _action_step
        {
            case 0:
                {
                    _body_sprite = _body_sprite_down
                    _body_x = 0
                    _body_y = -1
                    _body_image = 0
                    _body_speed = 0
