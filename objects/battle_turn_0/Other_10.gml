...
a.text = "{font FONT.SANS}{voice VOICE.SANS}So you finally come here,{sleep 20}&human.{pause}{clear}{emotion 1}Now,{sleep 20}This is the END.{pause}{clear}I'm going to make you&burn in hell."
