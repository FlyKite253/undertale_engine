...
var y_start=battle_board.y-20+lengthdir_y(length_start,_dir);
var x_target=battle_board.x+lengthdir_x(length_end,_dir);
var y_target=battle_board.y-20+lengthdir_y(length_end,_dir);
var x_start2=battle_board.x+lengthdir_x(length_start,_dir2);
var y_start2=battle_board.y-20+lengthdir_y(length_start,_dir2);
var x_target2=battle_board.x+lengthdir_x(length_end,_dir2);
var y_target2=battle_board.y-20+lengthdir_y(length_end,_dir2);
